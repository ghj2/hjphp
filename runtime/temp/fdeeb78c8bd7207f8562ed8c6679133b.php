<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:86:"/www/wwwroot/www.hjphp.com/wwwroot/public/../application/admin/view/message/index.html";i:1534229300;s:77:"/www/wwwroot/www.hjphp.com/wwwroot/application/admin/view/header_sidebar.html";i:1534237547;}*/ ?>
<!DOCTYPE html>
...
<body>
	...
	<div id="page-container" class="fade">
		...
		<div id="content" class="content">
			...
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">留言列表<small> Message List</small></h1>
			<!-- end page-header -->
                                ...
                                <table id="data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                    	...
                                    	<tr>
                                            ...
                                            <td><?php echo substr($item['content'],0,20);?></td>
                                            <td><?php echo date("Y-m-d H:i:s",$item['addtime']);?></td>
                                            <td>
												<a href="<?php echo url('message_edit',['id'=>$item['id']]); ?>">编辑</a>
												<a href="<?php echo url('message_del',['id'=>$item['id']]); ?>">删除</a>
											</td>
                                    	</tr>
