<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:89:"/www/wwwroot/www.hjphp.com/wwwroot/public/../application/admin/view/footprints/index.html";i:1534325524;s:77:"/www/wwwroot/www.hjphp.com/wwwroot/application/admin/view/header_sidebar.html";i:1534237547;}*/ ?>
<!DOCTYPE html>
                                ...
                                <table id="data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                    	...
                                    	<tr>
                                            ...
                                            <td name="ip" value="<?php echo $item['ip']; ?>"><?php echo $item['ip']; ?></td>
                                            <td>NULL</td>
	...
	<script>
		...
		function init_ipaddress(){
			$("[name='ip']").each(function(i,n){
				...
				$.post("<?php echo url('show_ipaddress'); ?>",{ip:$(n).html()},function(res){
					$(n).next().html(res);
				});
			});
		}
