<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"D:\wamp64\www\tp5\public/../application/admin\view\article\article_edit.html";i:1536718316;s:60:"D:\wamp64\www\tp5\application\admin\view\header_sidebar.html";i:1534237547;}*/ ?>
<!DOCTYPE html>
				...
				<div class="col-md-6 ui-sortable" style="width:100%;">
                    ...
                    <div class="panel panel-inverse">
                        ...
                        <div class="panel-body">
                            ...
                            <input class="form-control" name="keywords" id="keywords" placeholder="关键词(TDK)" type="text" value="<?php echo $firm['keywords']; ?>">
                            <p></p>

                            <input class="form-control" name="description" id="description" placeholder="描述(TDK)" type="text" value="<?php echo $firm['description']; ?>">
                            <p></p>
