<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:75:"D:\wamp64\www\tp5\public/../application/admin\view\article\article_add.html";i:1536718177;s:60:"D:\wamp64\www\tp5\application\admin\view\header_sidebar.html";i:1534237547;}*/ ?>
<!DOCTYPE html>
...
<body>
	...
	<div id="page-container" class="fade">
		...
		<div id="content" class="content">
			<!-- begin page-header -->
			<h1 class="page-header">写文章<small> Add Article</small></h1>
			<!-- end page-header -->
				...
				<div class="col-md-6 ui-sortable" style="width:100%;">
                    ...
                    <div class="panel panel-inverse">
                        ...
                        <div class="panel-body">
                            <input class="form-control" name="index" id="index" placeholder="排序" type="number">
                            <p></p>

                            <input class="form-control" name="title" id="title" placeholder="标题" type="text">
                            <p></p>
                           
							<input class="form-control" name="title2" id="title2" placeholder="副标题" type="text">
                            <p></p>

                            <input class="form-control" name="keywords" id="keywords" placeholder="关键词(TDK)" type="text">
                            <p></p>

                            <input class="form-control" name="description" id="description" placeholder="描述(TDK)" type="text">
                            <p></p>
							...
							<textarea class="form-control" name="intro" id="intro" placeholder="简介"></textarea>
                            <p></p>
                            ...
                            <div class="input-group">
                                ...
                                <span class="input-group-addon">
                                    <input name="hide" id="nohide" type="radio" value="0">
                                </span>
                                <p class="form-control" id="delhide">显示</p>
                                <span class="input-group-addon">
                                    <input name="hide" id="hide" type="radio" value="1">
                                </span>
                                <p class="form-control" id="gohide">隐藏</p>
                            </div>
							<p></p>
							
							 <input class="form-control" name="viewnum" id="viewnum" placeholder="浏览量" type="number">
                            <p></p>

                             <input class="form-control" name="tag" id="tag" placeholder="标签" type="text">
                            <p></p>
