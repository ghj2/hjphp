<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"/www/wwwroot/www.hjphp.com/wwwroot/public/../application/admin/view/steal/list.html";i:1533707342;s:77:"/www/wwwroot/www.hjphp.com/wwwroot/application/admin/view/header_sidebar.html";i:1534237547;}*/ ?>
<!DOCTYPE html>
                                ...
                                <table id="data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                    	...
                                    	<tr>
                                            ...
                                            <td><?php echo date("Y-m-d H:i:s",$item['realtime']); ?></td>
                                            <td><?php echo date("Y-m-d H:i:s",$item['addtime']); ?></td>
                                            <td>
                                            	<a href="<?php echo url('article_edit',['id'=>$item['id']]); ?>">编辑</a>&nbsp;&nbsp;&nbsp;
                                            	<a href="<?php echo url('article_del',['id'=>$item['id']]); ?>">删除</a>
                                            </td>
                                    	</tr>
