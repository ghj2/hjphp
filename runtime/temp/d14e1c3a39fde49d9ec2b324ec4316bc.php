<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"/www/wwwroot/www.hjphp.com/wwwroot/public/../application/admin/view/user/index.html";i:1533282702;s:77:"/www/wwwroot/www.hjphp.com/wwwroot/application/admin/view/header_sidebar.html";i:1534237547;}*/ ?>
<!DOCTYPE html>
	...
	<div id="page-container" class="fade">
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				<!-- <li><button type="button" onclick="window.location.href='<?php echo url('article/article_add'); ?>'" class="btn btn-inverse m-r-5 m-b-5">用户</button></li> -->
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">用户列表<small> Article List</small></h1>
			<!-- end page-header -->
                            ...
                            <div class="table-responsive">
                                <table id="data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                    	...
                                    	<tr>
                                    		<td><img src="<?php echo $item['headpic']; ?>" onerror="javascript:this.src='/static/images/user-default.png'" style="height:40px;width:40px;"/></td>
                                    		<td><?php echo $item['id']; ?></td>
                                            <td><?php echo $item['username']; ?></td>
                                            <td><?php echo $item['province']; ?></td>
                                            <td><?php echo $item['city']; ?></td>
                                            <td><?php echo $item['district']; ?></td>
                                            <td><?php if($item['addtime']){
                                            	echo date("Y-m-d H:i:s",$item['addtime']);}
                                            	else{echo ''; }?></td>
                                            <td><a href="<?php echo url('user_edit',['id'=>$item['id']]); ?>">编辑</a></td>
                                    	</tr>
