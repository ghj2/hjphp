<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:93:"/www/wwwroot/www.hjphp.com/wwwroot/public/../application/admin/view/message/message_edit.html";i:1533533697;s:77:"/www/wwwroot/www.hjphp.com/wwwroot/application/admin/view/header_sidebar.html";i:1533547372;}*/ ?>
<!DOCTYPE html>
...
<body>
	...
	<div id="page-container" class="fade">
		...
		<div id="content" class="content">
			<!-- begin page-header -->
			<h1 class="page-header">修改留言<small> Edit Message</small></h1>
			<!-- end page-header -->
				...
				<div class="col-md-6 ui-sortable" style="width:100%;">
                    ...
                    <div class="panel panel-inverse">
                        ...
                        <div class="panel-body">
                            <input class="form-control" name="orderid" id="orderid" value="<?php echo $firm['orderid']; ?>" placeholder="排序" type="number">
                            <p></p>

							<textarea class="form-control" name="content" id="content" placeholder="简介" rows="5"><?php echo $firm['content']; ?></textarea>
                            <p></p>
							
							<div style="text-align:center;">
							<button type="button" id="subm" class="btn btn-sm btn-success">提交</button>
							</div>
