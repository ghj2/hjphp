<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:91:"/www/wwwroot/www.hjphp.com/wwwroot/public/../application/index/view/user/edit_userinfo.html";i:1534141579;s:69:"/www/wwwroot/www.hjphp.com/wwwroot/application/index/view/header.html";i:1534139910;s:69:"/www/wwwroot/www.hjphp.com/wwwroot/application/index/view/footer.html";i:1534144862;}*/ ?>
<!doctype html>
<html>
<head>
<meta charset="utf-8">
...
<article>
  <h1 class="t_nav"><span><?php echo config('head_sentence'); ?></span><a href="/" class="n1">网站首页</a><a class="n2">修改信息</a></h1>
  <div class="ab_box">
        ...
        <div class="news_infos"> 
			...
			<section class="content">
				...
				<div class="avatar"> 
					...
					<?php else: ?>
					<img src="<?php echo $userinfo['headpic']; ?>" id="up_headpic" style="height:100px;width:100px">
					<?php endif; ?>
					<input type="hidden" name="headpic" id="headpic" value="<?php echo $userinfo['headpic']; ?>"/>
				</div>
				
				<span class="input input--hoshi">
					<input class="input__field input__field--hoshi" type="text" readonly value="<?php echo $userinfo['username']; ?>"/>
				...
				<span class="input input--hoshi">
					<input class="input__field input__field--hoshi" type="date" name="birthday" id="birthday" value="<?php echo $userinfo['birthday']; ?>"/>
				...
				<span class="input input--hoshi">
					<input class="input__field input__field--hoshi" type="text" name="sign" id="sign" placeholder="说点骚话..." value="<?php echo $userinfo['sign']; ?>"/>
...
$(function(){
	...
	//edit专用
	var user_province = "<?php echo $userinfo['province']; ?>";
	var user_city = "<?php echo $userinfo['city']; ?>";
	var user_district = "<?php echo $userinfo['district']; ?>";
	if(user_province!=''){
